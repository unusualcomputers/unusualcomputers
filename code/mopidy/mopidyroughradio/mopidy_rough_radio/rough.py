...
from mopidy_browser import MopidyBrowser
from mopidy_search import MopidySearch
...
class GuiThread:
    ...
    def run_gui(self):
        gui=MopidyRough(self.q, self.core)
